...
{
    // printf("current : %d %d %d\n", currentIndex.index_x, currentIndex.index_y, currentIndex.index_z);
    // printf("target over: %d %d %d\n", targetIndex.index_x + truncatedX * 5, targetIndex.index_y + truncatedY * 5, targetIndex.index_z + truncatedZ * 5);
    // printf("target: %d %d %d\n", targetIndex.index_x, targetIndex.index_y, targetIndex.index_z);
